...
<script>
    ...
    this.page.url = '<?= $CurPageURL; ?>';  
    this.page.identifier = '<?= $detail['id'] ?>'; 
    };
    
    (function() { 
    var d = document, s = d.createElement('script');
    s.src = 'https://health-in-totality.disqus.com/embed.js';
...
<script id="dsq-count-scr" src="//health-in-totality.disqus.com/count.js" async></script>
</body>
</html>