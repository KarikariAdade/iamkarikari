					...
					<div class="main-content">
						...
						<div class="container-fluid pt-8">
							...
							<div class="row view-post-section">
								...
								<div class="col-md-8">
									<div class="row load_posts">
										<?php
										$fetch_post = $conn->query("SELECT * FROM posts ORDER BY id DESC LIMIT 1");
										...
										echo '<h2>There are no posts at the moment. Please <a href="add-post.php">add one</a></h2>';
									}
									?>

								</div>
								<button class="btn bg-gradient-dark" id="show_more_posts_btn"><span class="fa fa-arrow-down"></span></button>
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="assets/js/sidemenu.js">
</script>
